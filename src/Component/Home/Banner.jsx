...
const Banner = () => {
    return (
        ...
        <div className='flex justify-center items-center gap-x-4 text-xs  pt-4 pb-12'>
...
Vintage
  ...
  <div className="hero px-32 ">
  <div className="hero-content flex-col lg:flex-row-reverse">
            <div className='flex justify-center lg:w-1/2'>
              <img src={bannerImg1} className="max-w-sm rounded-full lg:w-80" />
              <div>
