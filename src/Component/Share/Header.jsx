    ...
    <div className="navbar bg-accent text-white lg:px-24">
      ...
      <div className="navbar-center hidden lg:flex">
        <div className="join relative">
          <input
            className="input bordered-0 rounded-3xl join-item "
            placeholder="Search SnipShop.com"
          />
          <button className="btn border-0 bg-[#4DC3F7]  rounded-l-full rounded-r-full absolute right-[-20px] ">
            ...
            <a>
              <label>
                <div className="indicator">
                  ...
                  <span className="badge badge-xs border-0 bg-[#FFC221] rounded-full  indicator-item">
                    8
                  </span>
                </div>
              </label>
